...
class Zoo:
    ...
    def __init__(self, animals_list):
        ...
        self.set_defualt_amount_of_food_for_two_weeks()
    ...
    def feed_all_animals(self):
        for animal in self.animals_list:
            if self.food_supply.get_food_amount(animal.get_food_type()) < animal.get_food_quantity():
                ...
                self.food_supply.add_food_item_by_amount(
                    animal.get_food_type(), animal.get_food_quantity())
            self.food_supply.dec_food_item_by_amount(
                animal.get_food_type(), animal.get_food_quantity())
            animal.eat()
    ...
    def get_details_zoo_animals(self):
        for animal in self.animals_list:
            print(animal)
